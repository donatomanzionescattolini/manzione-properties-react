...
export function Maintenance() {
  const { maintenanceRequests, tenants, properties, vendors, technicians, updateMaintenanceRequest } = useDataStore();
  ...
  const onStatusSubmit = async (data: StatusUpdateForm) => {
    ...
    if ((data.vendorId || data.technicianId) && !statusTarget.assignedDate) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
          {filtered.map((r) => (
            ...
            >
              ...
              {r.technicianId && (
                <p className="text-xs text-blue-600 mb-1">🔧 {getTechnicianName(r.technicianId)}</p>
              )}
        ...
        {viewTarget && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              {viewTarget.technicianId && (
                <div>
                  <p className="text-gray-500 font-medium">Technician</p>
                  <p>{getTechnicianName(viewTarget.technicianId)}</p>
                </div>
              )}
      ...
      >
        {statusTarget && (
          <div className="space-y-4">
            ...
            <div>
              <label className="label">Assign Vendor (optional)</label>
            ...
            <div>
              ...
              <select {...regStatus('technicianId')} className="input-field">
                <option value="">Unassigned</option>
